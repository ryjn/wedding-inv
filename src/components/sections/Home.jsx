    ...
    <RevealOnScroll>
      ...
      >
        ...
        <div className="w-[90%] md:w-[70%] flex flex-row justify-between items-center">
          <div className="flex-1 flex-row text-left space-y-1 md:space-y-3">
            <h3 className="text-sm md:text-base font-sansKR">신랑</h3>
            <h1 className="text-2xl md:text-5xl font-nanum tracking-wider">
              김준
            </h1>
          </div>
          <div className="flex-1 flex-row text-center space-y-1 md:space-y-3">
            <h3 className="text-xl md:text-3xl font-nanum text-[var(--color-accent)]">
              05
            </h3>
          ...
          <div className="flex-1 flex-row text-right space-y-1 md:space-y-3">
        ...
        <div className="text-center space-y-3">
          <h2 className="text-lg md:text-2xl font-nanum font-medium">
            2025.05.31
          </h2>
          <div className="">
        ...
        <div className="flex flex-col">
          <h3 className="py-4 text-base md:text-xl text-center">
            오가헌 찾아오시는 길
          </h3>
